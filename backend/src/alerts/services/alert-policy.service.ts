...
import type { AlertEventIngressDto } from '../dto/alert-events.dto';
...
export type AlertSuppressedReason = 'cooldown' | 'hourly_cap';
...
export class AlertPolicyService {
  ...
  evaluate(event: AlertEventIngressDto): AlertPolicyDecision {
