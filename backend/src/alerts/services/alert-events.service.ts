...
import { ALERT_CHANNEL_PORT, type ChannelPort } from '../ports/channel.port';
import {
  ALERT_PREDICTION_PORT,
  type PredictionPort,
} from '../ports/prediction.port';
import type { ExistingAlertEventAggregate } from '../repositories/alert-events.repository';
