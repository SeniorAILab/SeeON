...
[Service]
Type=oneshot
WorkingDirectory=/opt/eldercare-fall-ai
...
ExecStart=/bin/sh /opt/eldercare-fall-ai/scripts/edge-updater/update-edge.sh
```
...
<dict>
  ...
  <key>WorkingDirectory</key><string>/opt/eldercare-fall-ai</string>
  <key>ProgramArguments</key>
  <array>
    <string>/bin/sh</string>
    <string>/opt/eldercare-fall-ai/scripts/edge-updater/update-edge.sh</string>
  </array>
