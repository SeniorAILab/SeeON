  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/45 p-4 backdrop-blur-sm" role="dialog" aria-modal="true">
      <div className="w-full max-w-md rounded-4xl bg-white p-6 shadow-glow">
        ...
        <h2 className="mt-2 text-2xl font-black text-slate-950">{camera.label} 삭제</h2>
        ...
        <div className="mt-6 flex justify-end gap-3">
          <button type="button" onClick={onCancel} className="rounded-full bg-slate-100 px-5 py-3 text-sm font-black text-slate-600">취소</button>
