...
export function CameraEventLivePanel({
  ...
  return (
    <div className="space-y-4">
      ...
      />
      <section className="rounded-3xl bg-white p-4 text-slate-900">
        <div className="flex items-center justify-between gap-3">
          <h3 className="font-black">클립 이력</h3>
          <span className="rounded-full bg-slate-100 px-3 py-1 text-xs font-black text-slate-600">{evidenceClips.length}개</span>
        </div>
