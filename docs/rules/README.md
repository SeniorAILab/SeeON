...
| [ml-training.md](./ml-training.md) | stub | Training moved to eldercare-dataset-ops (ADR-0004); this file only tracks what fall-ai kept (`ml/artifact_metadata/`, vendored `contracts`/`features`) and points to the sibling repo for the active pipeline rules. |
