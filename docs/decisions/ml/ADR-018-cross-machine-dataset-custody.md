...
- Rejected: violates the privacy perimeter. Nursing-home footage must stay on
  operator-controlled disks (custody owned here; the demo stays local-only per ADR-045).
