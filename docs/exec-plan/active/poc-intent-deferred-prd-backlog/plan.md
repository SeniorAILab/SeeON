...
Record the deleted 2F POC ideas in the <vault> PRD as deferred future requirements only. They should remain visible for later product design, but they must not imply current MVP implementation work.
