...
- **CURRENT — hybrid auth refinement:** email/password and Kakao both use the ADR-033/ADR-069 backend session boundary without leaking Kakao tokens to the browser.
