...
- Add `docs/decisions/ml/ADR-068-ml-edge-worker-portable-video-runtime.md` and update `docs/decisions/README.md`.
...
- [ ] 1. Create canonical repo execution plan and freeze scope
  ...
  References (executor has NO interview context - be exhaustive): `AGENTS.md` plan-first mandate; `.omo/plans/ml-edge-a-worker-portable-runtime-layout.md`; `docs/decisions/ml/ADR-067-ml-edge-api-worker-service-split.md:24`; `docs/decisions/common/ADR-062-host-edge-compose-topology.md:18`
...
- [ ] 2. Add RED topology tests for host/edge Compose and explicit Dockerfiles
  ...
  References: `compose.edge.yaml:11`; `compose.edge.yaml:38`; `compose.yaml`; `compose.prod.yaml`; `ml/Dockerfile:34`; `ml/Dockerfile:52`; `docs/decisions/common/ADR-062-host-edge-compose-topology.md:18`
...
- [ ] 3. Add RED FastAPI boundary tests for routes, payloads, and forbidden imports
  ...
  References: `ml/serving/main.py:20`; `ml/serving/routes/debug.py`; `ml/serving/edge_worker.py:1`; `docs/api/ml-serving-api.md:3`; `docs/decisions/ml/ADR-067-ml-edge-api-worker-service-split.md:41`
...
- [ ] 5. Split edge Dockerfiles and update edge Compose
  ...
  References: `ml/Dockerfile`; `compose.edge.yaml:11`; `compose.edge.yaml:38`; `ml/pyproject.toml:8`; `ml/pyproject.toml:35`; `docs/decisions/common/ADR-062-host-edge-compose-topology.md:22`
...
- [ ] 7. Harden worker runtime ownership and concurrency invariants
  ...
  References: `docs/decisions/ml/ADR-067-ml-edge-api-worker-service-split.md:31`; `ml/runtime/edge_worker_supervisor.py:52`; `ml/runtime/camera_worker.py:43`; `ml/worker/edge_worker.py:124`; `ml/tests/test_worker_runner_sharing.py:26`; `ml/tests/test_edge_worker_four_streams.py:24`; `ml/tests/test_import_dependency_ladder.py:121`
...
- [ ] 12. Run full deterministic and real-surface verification
  ...
  References: all above; `docs/decisions/ml/ADR-067-ml-edge-api-worker-service-split.md:61`; `ml/config/edge-cameras.example.json`
