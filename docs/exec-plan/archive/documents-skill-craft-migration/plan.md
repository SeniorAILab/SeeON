...
2. Fast-forward `/Users/beomsu/dev/GoBeromsu/craft-skills` to the current GitHub
   `main` when possible.
...
- `git -C /Users/beomsu/dev/GoBeromsu/craft-skills rev-parse HEAD` matches
  GitHub `main` for GoBeromsu/craft-skills.
- `readlink /Users/beomsu/.claude/skills/documents` and
  `readlink /Users/beomsu/.codex/skills/documents` point to the craft-skills
  checkout.
