...
This plan also patches the Obsidian Ataraxia PRD so the product source of truth matches the route and UI work.
...
- Ataraxia PRD directly records the final UI journey and dashboard API convention.
